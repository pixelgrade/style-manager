...
class ThemeConfigs extends AbstractHookProvider {
	...
	public function register_hooks() {
		 ...
		 */
		$this->add_filter( 'style_manager/filter_fields', 'maybe_activate_external_theme_config', 10, 1 );
		$this->add_filter( 'style_manager/filter_fields', 'maybe_apply_external_theme_config', 100, 1 );
	...
	protected function get_theme_configs( bool $skip_cache = false ): array {
		...
		return apply_filters( 'style_manager/get_theme_configs', $theme_configs );
	}
	...
	protected function maybe_apply_external_theme_config( array $config ): array {
		...
		// If we are dealing with the Style Manager default config, we need a clean slate, sort of.
