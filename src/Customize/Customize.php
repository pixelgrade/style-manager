<?php
/**
 * This is the class that handles the overall logic for the customize experience.
 *
 * @since   2.0.0
...
/**
 * Provides the customize general logic.
 *
 * @since 2.0.0
 */
class Customize extends AbstractHookProvider {
	...
	public function register_hooks() {
		 ...
		 */
		$this->add_filter( 'style_manager/filter_fields', 'setup_sm_section_base_config', 12, 1 );
		 ...
		 */
		$this->add_filter( 'style_manager/final_config', 'filter_based_on_theme_type', 20, 1 );
	 ...
	 * @return array
	 */
	protected function reorganize_sections( array $config ): array {
		// If there is no Style Manager support, bail early.
		if ( ! $this->is_supported() ) {
			return $config;
		}
	...
	/**
	 * Reorganize the Customizer sections and panels, without accounting for Style Manager's configured ones.
	 *
