...
export const convertToColorSelect = ( element ) => {
  ...
  const $colorSelect = $( '<div class="style-manager-color-select">' );
  const settingID = $select.data( 'customize-setting-link' );

  const $optionsList = $( '<div class="style-manager-color-select__option-list">' );

  $selectOptions.each( function( i, option ) {
    const $option = $( option );
    const label = $option.text();
    const value = $option.attr( 'value' );
    const $colorSelectOptionLabel = $( '<div class="style-manager-color-select__option-label">' );
    const $colorSelectOption = $( '<div class="style-manager-color-select__option">' );
  ...
  const $colorSelectOptions = $colorSelect.find( '.style-manager-color-select__option' );
