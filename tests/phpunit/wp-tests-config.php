...
define( 'DB_NAME', $_ENV['WP_TESTS_DB_NAME'] ?? 'wordpress_test' );
define( 'DB_USER', $_ENV['WP_TESTS_DB_USER'] ?? 'root' );
define( 'DB_PASSWORD', $_ENV['WP_TESTS_DB_PASSWORD'] ?? '' );
define( 'DB_HOST', $_ENV['WP_TESTS_DB_HOST'] ?? 'localhost' );
