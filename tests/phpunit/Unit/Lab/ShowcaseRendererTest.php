...
class ShowcaseRendererTest extends TestCase {
	public function test_render_outputs_unique_value_showcase_sections(): void {
		...
		$this->assertMatchesRegularExpression( '/data-sm-lab-cascade-node="page"(?:(?!data-sm-lab-cascade-node=)[\s\S])*data-sm-lab-cascade-rail-grade="4"(?:(?!data-sm-lab-cascade-rail-grade=)[\s\S])*data-sm-lab-cascade-rail-marker="resolved"/', $html );
