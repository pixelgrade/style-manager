...
class StyleManager_Cloud_Api {
	...
	public function init() {
		...
		self::$externalApiEndpoints = apply_filters( 'style_manager_external_api_endpoints', array(
			'cloud' => array(
	...
	public function fetch_design_assets() {
		$request_data = apply_filters( 'style_manager_pixelgrade_cloud_request_data', array(
			'site_url' => home_url('/'),
		...
		return apply_filters( 'style_manager_fetch_design_assets', $response_data['data'] );
	}
	...
	public function get_active_theme_data() {
		...
		return apply_filters( 'style_manager_get_theme_data', $theme_data );
	}
	...
	public function send_stats( $request_data = array(), $blocking = false ) {
		 ...
		 */
		$request_data = apply_filters( 'style_manager_pixelgrade_cloud_request_data', $request_data, $this );
