<?php
/**
 * Document for class StyleManager_Plugin_Init.
 */
 ...
 */
abstract class StyleManager_Plugin_Init extends StyleManager_Singleton_Registry {
	...
	public function get_version_saved() {
		...
		return StyleManager_Options::getInstance()->get_option( 'version' );
	}
	...
	public function save_version_number() {
		StyleManager_Options::getInstance()->update_option( 'version', $this->_version );
