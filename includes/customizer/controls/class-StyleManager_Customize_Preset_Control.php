	...
	public function render_content() {
		...
		switch ( $this->choices_type ) {
			...
			<label>
				...
				<select <?php $this->link(); ?> class="sm_preset select">
					<?php
			...
			case 'radio' : { ?>
				<label>
					...
					<div class="sm_preset radio customize-control customize-control-radio">
						<?php
						foreach ( $this->choices as $choice_value => $choice_config ){
							if ( ! isset( $choice_config['options']) || ! isset( $choice_config['label'] ) ) {
								continue;
			...
			case 'buttons' : { ?>
				<label>
					...
					<div class="sm_preset radio_buttons">
						<?php
						foreach ( $this->choices as $choice_value => $choice_config ){
							if ( ! isset( $choice_config['options']) || ! isset( $choice_config['label'] ) ) {
								continue;
							...
							<fieldset class="sm_radio_button">
			...
			case 'color_palette' : { ?>
                ...
                <div class="sm_preset color_palette customize-control customize-control-radio">
                    <?php
                    foreach ( $this->choices as $choice_value => $choice_config ){
			...
			case 'font_palette' : { ?>
				...
				<div class="sm_preset font_palette customize-control customize-control-radio">
					<?php
					foreach ( $this->choices as $choice_value => $choice_config ){
			...
			case 'awesome' : { ?>
				<label>
					...
					<div class="sm_preset awesome_presets">
						<?php
