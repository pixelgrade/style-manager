...
/**
 * Class StyleManager_Customize_Background_Control.
 *
 * A custom background image control.
 */
class StyleManager_Customize_Background_Control extends StyleManager_Customize_Control {
