...
class StyleManager_Customize_Font_Control extends StyleManager_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		self::$std_fonts = apply_filters( 'style_manager_filter_standard_fonts_list', array(
...
//		$this->generate_google_fonts_json();
	...
	public function render_content() {
		...
		<div class="font-options__wrapper">
			...
			<input type="checkbox" class="sm_font_tooltip"
			...
			<ul class="font-options__options-list">
				<li class="font-options__option customize-control">
					<select id="select_font_font_family_<?php echo esc_attr( $this->CSSID ); ?>" class="sm_font_family"<?php echo $select_data; ?> data-field="font_family">
						<?php
						// Allow others to add options here
						do_action( 'sm_font_family_before_options', $font_family, $current_value );
	...
	function display_recommended_options_group( $font_family, $current_value ) {
		// Allow others to add options here
		do_action( 'sm_font_family_before_recommended_fonts_options', $font_family, $current_value );
	...
	function display_standard_options_group( $font_family, $current_value ) {
		...
		// Allow others to add options here
		do_action( 'sm_font_family_after_standard_fonts_options' );
	}
	...
	function display_font_weight_field( $current_value ) {
		...
		<li class="sm_weights_wrapper customize-control font-options__option" style="display: <?php echo $display; ?>;">
			<select class="sm_font_weight" data-field="selected_variants" <?php echo ! empty( $current_value->selected_variants ) ? 'data-default="' . $current_value->selected_variants . '"' : ''; echo ( isset( $this->fields['font-weight'] ) && false === $this->fields['font-weight'] ) ? 'data-disabled' : ''; ?>>
				<?php
				$selected = array();
	...
	function display_font_subset_field( $current_value ) {
		...
		<li class="sm_subsets_wrapper customize-control font-options__option" style="display: <?php echo $display; ?>;">
			<select multiple class="sm_font_subsets" data-field="selected_subsets" <?php echo ( isset( $this->fields['subsets'] ) && false === $this->fields['subsets'] ) ? 'data-disabled' : ''; ?>>
				<?php
				$selected = array();
	...
	protected function load_google_fonts() {
		...
		if ( ! empty( self::$google_fonts ) ) {
			return apply_filters( 'style_manager_filter_google_fonts_list', self::$google_fonts );
		}
