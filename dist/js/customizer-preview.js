...
var getFieldUnit = function getFieldUnit(settingID, field) {
  ...
  if (typeof styleManager.config.settings[settingID].fields[field].unit !== 'undefined') {
    ...
    return external_lodash_default().includes(['', 'false', false], styleManager.config.settings[settingID].fields[field].unit) ? false : styleManager.config.settings[settingID].fields[field].unit;
  }

  if (typeof styleManager.config.settings[settingID].fields[field][3] !== 'undefined') {
    // Make sure that we convert all falsy unit values to the boolean false.
    return external_lodash_default().includes(['', 'false', false], styleManager.config.settings[settingID].fields[field][3]) ? false : styleManager.config.settings[settingID].fields[field][3];
  }
...
var getFontFamilyFallbackStack = function getFontFamilyFallbackStack(fontFamily) {
  ...
  if (typeof fontDetails.fallback_stack !== 'undefined' && !external_lodash_default().isEmpty(fontDetails.fallback_stack)) {
    ...
    if (typeof styleManager.fonts.categories[category] !== 'undefined') {
      ...
      external_lodash_default().find(styleManager.fonts.categories, function (categoryDetails) {
...
(function ($, window, document) {
  var _window$parent, _window$parent$styleM, _window$parent$styleM2;
  ...
  window.fontsCache = [];
  var settings = window === null || window === void 0 ? void 0 : (_window$parent = window.parent) === null || _window$parent === void 0 ? void 0 : (_window$parent$styleM = _window$parent.styleManager) === null || _window$parent$styleM === void 0 ? void 0 : (_window$parent$styleM2 = _window$parent$styleM.config) === null || _window$parent$styleM2 === void 0 ? void 0 : _window$parent$styleM2.settings;
...
(window.sm = window.sm || {}).customizerPreview = __webpack_exports__;
/******/ })()
;