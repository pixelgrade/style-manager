...
- [Rosa LT](https://pixelgrade.com/themes/restaurants/rosa-lt/)

Some controls appear only when the active theme or blocks provide support for them.

## How to Try It

1. Install and activate Style Manager from [WordPress.org](https://wordpress.org/plugins/style-manager/).
...
If you identify an issue or have an idea for improving Style Manager, open a [GitHub issue](https://github.com/pixelgrade/style-manager/issues) or use the [WordPress.org support forum](https://wordpress.org/support/plugin/style-manager/).

## Documentation

Start with the [documentation index](docs/index.md), then see [installation](docs/installation.md), [settings](docs/settings.md), [integrations](docs/integrations.md), and [troubleshooting](docs/troubleshooting.md).
